...
const ContactSection = () => {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: contact.email || "contact@example.com", href: `mailto:${contact.email || "contact@example.com"}` },
    { icon: Phone, label: "Phone", value: contact.phone || "+91-XXXXXXXXXX", href: `tel:${contact.phone || ""}` },
    { icon: MapPin, label: "Location", value: contact.location || "Belagavi, Karnataka", href: "#" },
  ];
